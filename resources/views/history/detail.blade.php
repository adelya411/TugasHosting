        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5>Pesanan anda sudah sukses dicheck out selanjutnya untuk pembayaran silahkan transfer di rekening <strong>Bank BNI Nomor Rekening : 1316148155</strong> dengan nominal : <strong>Rp. {{ number_format($pesanan->kode+$pesanan->jumlah_harga) }}</strong></h5>
                </div>
            </div>
            <div class="card mt-2">
                <div class="card-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <td>
                                    <a href="{{ url('rating') }}" class="btn btn-success" onclick="return confirm('Anda akan membuat Rating Pesanan');">
                                        <i class="fa fa-shopping-cart"></i> Rating Pesanan
                                    </a>
                                </td>
                    </table>
                    @endif
